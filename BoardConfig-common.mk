...
TARGET_KERNEL_CLANG_VERSION := clang-r433403
TARGET_KERNEL_USE_LLVM_IAS=true
TARGET_KERNEL_ADDITIONAL_FLAGS := \
    DTC_EXT=$(shell pwd)/prebuilts/build-tools/kernel/bin/dtc \
    DTC_OVERLAY_TEST_EXT=$(shell pwd)/prebuilts/build-tools/kernel/bin/ufdt_apply_overlay
